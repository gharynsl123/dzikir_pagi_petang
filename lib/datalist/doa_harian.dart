...
import 'package:project_app_aplikasi_zdikir/barview/daily_bar.dart';
...
final descTextStyle =
baseTextStyle.copyWith(fontSize: 16.0, fontWeight: FontWeight.w500);
...
class _ItemListState extends State<ItemList> {
    ...
    return Container(
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            final subs = arabDoa[index].toString();
                ...
                child: Stack(
                  children: <Widget>[
                    Container(
                      ...
                      child: ItemList(title, subs, arti),
                      decoration: BoxDecoration(
                          color: Color(0xff0758FF),
  ...
  ItemList(String title, String subs, String arti){
    return Container(
