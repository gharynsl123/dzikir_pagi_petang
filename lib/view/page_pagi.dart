...
import 'package:project_app_aplikasi_zdikir/datalist/item_dzikir_l.dart';

class MainPagi extends StatefulWidget {
  @override
  _MainPagiState createState() => _MainPagiState();
}
class DzikirPagi {
  String judulPagi;
  String arabPagi;
  ...
  DzikirPagi(this.judulPagi, this.arabPagi, this.artiPagi);
}
List<DzikirPagi> dataPagi = [
  DzikirPagi(
    "Ta\'awudz",
  ...
  DzikirPagi("", "سُبْحَانَ اللهِ وَبِحَمْدِهِ",
  ...
  DzikirPagi("", "أَسْتَغْفِرُ اللهَ وَأَتُوْبُ إِلَيْهِ",
...
class _MainPagiState extends State<MainPagi> {
  @override
    ...
    return Scaffold(
      body: PageView.builder(
        ...
        itemBuilder: (context, index) {
          String judulPa = dataPagi[index].judulPagi;
          String arabPa = dataPagi[index].arabPagi;
          String artiPa = dataPagi[index].artiPagi;

          return ItemDzikirPagi(judulPag: judulPa, arabPag: arabPa, artiPag: artiPa);
        },
      ),
    );
  }
