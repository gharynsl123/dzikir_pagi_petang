...
import 'package:project_app_aplikasi_zdikir/datalist/item_dzikir.dart';
import 'package:project_app_aplikasi_zdikir/view/page_pagi.dart';

class MainPetang extends StatefulWidget {
  @override
  _MainPetangState createState() => _MainPetangState();
}
class DzikirPetang {
  String judulPetang;
  String arabPetang;
  ...
  DzikirPetang(this.judulPetang, this.arabPetang, this.artiPetang);
}

List<DzikirPetang> dataPetang = [
  DzikirPetang(
    "Ta\'awudz",
  ...
  DzikirPetang("", "سُبْحَانَ اللهِ وَبِحَمْدِهِ",
  ...
  DzikirPetang("", "أَسْتَغْفِرُ اللهَ وَأَتُوْبُ إِلَيْهِ",
...
class _MainPetangState extends State<MainPetang> {
  @override
    ...
    return Scaffold(
      body: PageView.builder(
        ...
        itemBuilder: (context, index) {
          String judulPe = dataPetang[index].judulPetang;
          String arabPe = dataPetang[index].arabPetang;
          String artiPe = dataPetang[index].artiPetang;

          return ItemDzikirPetang(judulPet: judulPe, arabPet: arabPe, artiPet: artiPe,);
        },
      ),
    );
  }
